...
namespace CMS.DocumentEngine.Types.CMS
{
	...
	public partial class MenuItem : TreeNode
	{
		...
		/// </summary>
		[DatabaseField]
		public long MenuItemParentID
		{
			get
			{
				return ValidationHelper.GetLong(GetValue("MenuItemParentID"), 0);
			}
			set
			{
				SetValue("MenuItemParentID", value);
			}
		}
		...
		public bool IsMegamenu
		{
			get
			{
				return ValidationHelper.GetBoolean(GetValue("IsMegamenu"), true);
			}
			set
			{
				SetValue("IsMegamenu", value);
			}
		}
		...
		public bool isHeading
		{
			get
			{
				return ValidationHelper.GetBoolean(GetValue("isHeading"), false);
			}
			set
			{
				SetValue("isHeading", value);
			}
		}
		...
		public partial class MenuItemFields : AbstractHierarchicalObject<MenuItemFields>
		{
			...
			public long ParentID
			{
				get
				{
					return mInstance.MenuItemParentID;
				}
				set
				{
					mInstance.MenuItemParentID = value;
				}
			}
			...
			public DocumentAttachment TeaserImage
			{
				get
				{
					return mInstance.GetFieldDocumentAttachment("MenuItemTeaserImage");
				}
			}
			...
			public bool IsMegamenu
			{
				get
				{
					return mInstance.IsMegamenu;
				}
				set
				{
					mInstance.IsMegamenu = value;
				}
			}
			...
			public bool isHeading
			{
				get
				{
					return mInstance.isHeading;
				}
				set
				{
					mInstance.isHeading = value;
				}
			}
		}

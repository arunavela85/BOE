...
using dcboe.Components.PageBuilder.Widgets.SelectorsWidget;


// Assembly attribute to register the widget for the connected Xperience instance.
[assembly: RegisterWidget("dcboe.Widgets.SelectorsWidget", 
                            typeof(HeadingWidgetViewComponent),
                            "Selectors demo",
                            typeof(SelectorsWidgetProperties))]

namespace dcboe.Components.PageBuilder.Widgets.SelectorsWidget
{
    public class HeadingWidgetViewComponent : ViewComponent
    {
        ...
        public HeadingWidgetViewComponent(IPageAttachmentUrlRetriever attachmentUrlRetriever,

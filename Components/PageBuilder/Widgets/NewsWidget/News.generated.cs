...
namespace CMS.DocumentEngine.Types.CMS
{
	...
	public partial class News : TreeNode
	{
		...
		/// </summary>
		[DatabaseField]
		public bool DocumentReader
		{
			get
			{
				return ValidationHelper.GetBoolean(GetValue("DocumentReader"), false);
			}
			set
			{
				SetValue("DocumentReader", value);
			}
		}
		...
		public partial class NewsFields : AbstractHierarchicalObject<NewsFields>
		{
			...
			public bool DocumentReader
			{
				get
				{
					return mInstance.DocumentReader;
				}
				set
				{
					mInstance.DocumentReader = value;
				}
			}
		}
